...
problemKey = 'FON'
isStochastic = True
std = 0.1 #KUR:0.1, POL:0.1, FON:0.1
numTrials = 10
numLatticeDim = 20
numPop = 60
animationOn = False
...
#problem dictionary
probDict ={
    'FON': ['FON',prs.Problem.fon(numLatticeDim,isStochastic,std,problemDim,np.array(ref_point),discreteLevel),prs.problemGMO.fon(problemDim)],
